...
export const blogArticles: BlogArticleMeta[] = [
  ...
  },
  {
    ...
    title: "NYC Rent Stabilization & Rent Increase Laws (2026): Renewal Rates, Tenant Rights",
    description:
      "Annual rent increase rules for NYC rent stabilized apartments: 2025-2026 RGB rates (3% one-year, 4.5% two-year), lease renewal rights, how to check if your apartment is stabilized, and what to do if you're being overcharged.",
