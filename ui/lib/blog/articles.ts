...
export const blogArticles: BlogArticleMeta[] = [
  ...
  },
  {
    ...
    description:
      "The FARE Act ended tenant-paid broker fees in NYC. Learn who pays now, how much you save, DCWP enforcement one year later, six common r/AskNYC FARE Act questions answered, and an interactive violation reporter that drafts a copy-paste DCWP complaint.",
