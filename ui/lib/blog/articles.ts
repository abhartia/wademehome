...
export const blogArticles: BlogArticleMeta[] = [
  ...
  },
  {
    ...
    description:
      "The FARE Act ended tenant-paid broker fees in NYC. Learn who pays now, how much you save, DCWP enforcement one year later, and what to watch for when apartment hunting.",
  ...
  },
  {
    ...
    description:
      "Annual rent increase rules for NYC rent stabilized apartments: 2025-2026 RGB rates (3% one-year, 4.5% two-year), full 2015–2026 Rent Guidelines Board history, lease renewal rights, how to check if your apartment is stabilized, and what to do if you're being overcharged.",
